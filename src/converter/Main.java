...
public class Main {
	...
	private static void printHelp() {
		...
		System.out.println("                ToHex 转为十六进制数字");
		System.out.println("                ToBin 转为二进制数字");
		System.out.println();
		System.out.println("                Base64Decode 译码base64");
		System.out.println("                Base32Decode 译码base32");
		System.out.println("                DeHex 将十六进制数字转回原文");
		System.out.println("                DeBin 将二进制数字转回原文");
		System.out.println();
		System.out.println("                MorseCodeEncode 转为莫尔斯电码（仅英文）");
